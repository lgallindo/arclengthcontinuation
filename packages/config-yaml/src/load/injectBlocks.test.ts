...
schema: v1
rules:
  - "Input: \${{ inputs.userSetting }} | Secret: \${{ secrets.apiKey }} | ArclengthContinuation: \${{ continue.workspaceRoot }}"
`;
    ...
    expect(ruleText).toBe(
      "Input: ${{ secrets.//userSetting }} | Secret: ${{ secrets.//apiKey }} | ArclengthContinuation: ${{ continue.workspaceRoot }}",
    );
    ...
    expect(configStr).toContain("arclength-continuation.workspaceRoot");
  });
