# @arclength-continuation/llm-info
...
Whereas @arclength-continuation/openai-adapters is responsible for translation between API types, @arclength-continuation/llm-info is concerned with
...
We know we are done when the steps required to add support for a new model in Arclength-Continuation are exactly
