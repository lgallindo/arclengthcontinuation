...
describe("validateGitHubRepoUrl", () => {
  it("should accept valid repository names", () => {
    expect(validateGitHubRepoUrl("arclength-continuation/continue")).toBe(true);
...
describe("sanitizeShellArgument - integration tests", () => {
  ...
  it("should handle git stash message use case safely", () => {
    ...
    const stashMessage = `ArclengthContinuation: Stashed before opening agent ${agentId}`;
    ...
    expect(result).toContain(
      "ArclengthContinuation: Stashed before opening agent",
    );
