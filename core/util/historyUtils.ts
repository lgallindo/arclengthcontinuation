...
import { getArclengthContinuationGlobalPath } from "../util/paths.js";
...
export function toMarkDown(history: ChatMessage[], time?: Date): string {
  ...
  let content = `### [ArclengthContinuation](https://arclength-continuation.dev) session transcript\n Exported: ${time.toLocaleString()}`;
...
export async function shareSession(
  ...
  outputDir = outputDir ?? getArclengthContinuationGlobalPath();
