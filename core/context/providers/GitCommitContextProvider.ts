...
class GitCommitContextProvider extends BaseContextProvider {
  ...
  get deprecationMessage() {
    return "The git commits context provider is now deprecated and may be removed in a later version. Please consider using the Git MCP (https://arclength-continuation.dev/docker/mcp-git) instead.";
  }
