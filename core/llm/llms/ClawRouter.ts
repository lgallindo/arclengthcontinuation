...
// Get ArclengthContinuation version from package.json at build time
...
class ClawRouter extends OpenAI {
  ...
  /**
   * Override headers to include ArclengthContinuation-specific User-Agent
   * This helps ClawRouter track integration usage and optimize accordingly
   */
  protected _getHeaders() {
    return {
      ...super._getHeaders(),
      "User-Agent": `ArclengthContinuation/${CONTINUE_VERSION}`,
      "X-ArclengthContinuation-Provider": "clawrouter",
    };
  }
}
