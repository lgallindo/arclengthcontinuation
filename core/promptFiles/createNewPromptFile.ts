...
# It is used to define and reuse prompts within ArclengthContinuation
...
# To learn more, see the full .prompt file reference: https://docs.arclength-continuation.dev/features/prompt-files
name: Example
