...
If any of these tools are unavailable, inform the user that they need to activate them and enable "Agent Mode" in ArclengthContinuation before proceeding.
...
3. Explain that ArclengthContinuation will automatically load this file into context when working with the project
