...
# To learn more, see the full config.yaml reference: https://docs.arclength-continuation.dev/reference
...
# https://docs.arclength-continuation.dev/customization/models
models:
  - name: my gpt-5
    provider: openai
    model: gpt-5
