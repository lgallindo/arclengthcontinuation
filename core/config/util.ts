 ...
 *
 * See here for details: https://github.com/arclength-continuation/continue/issues/940
 */
...
async function showUnsupportedCpuToast(ide: IDE) {
  ...
  if (shouldOpenLink) {
    void ide.openUrl(
      "https://docs.arclength-continuation.dev/troubleshooting#i-received-a-codebase-indexing-disabled---your-linux-system-lacks-required-cpu-features-avx2-fma-notification",
    );
  }
}
