...
| :---------- | :-------- | :----------------- |
| Paper       | `#E8E2D6` | Field              |
| Ink         | `#2C2A28` | Curves, type       |
| Clay blue   | `#6B7F8F` | Scaffold / plane   |
| Oxide       | `#A65D3F` | Fold / singularity |
| Sage        | `#7A8F6E` | Accepted step      |
| Dust violet | `#7E6B8A` | Sparse wash only   |

## Apps checklist

- Extension / IDE chrome: ink on paper or dark ink field; accent oxide sparingly
- CLI TUI: prefer ink/sage/oxide over Continue lavender
