...
[Claude Sonnet 4.6](https://continue.dev/anthropic/claude-sonnet-4-6) from Anthropic

1. Get your API key from [Anthropic](https://console.anthropic.com/)
2. Add [Claude Sonnet 4.6](https://continue.dev/anthropic/claude-sonnet-4-6) to your Continue config
...
2. Add [Qwen Coder 3 480B](https://continue.dev/openrouter/qwen3-coder)  your Continue config
...
2. Add [GPT-5](https://continue.dev/openai/gpt-5)  your Continue config
...
1. Get your API key from [OpenRouter](https://openrouter.ai/settings/keys)
2. Add [Kimi K2](https://continue.dev/openrouter/kimi-k2)  your Continue config
3. Add `OPENROUTER_API_KEY` to your environment or config
4. Click `Reload config` in the config selector in the Continue IDE extension

[Gemini 3.1 Pro](https://continue.dev/google/gemini-3.1-pro-preview) from Google

1. Get your API key from [Google AI Studio](https://aistudio.google.com)
2. Add [Gemini 3.1 Pro](https://continue.dev/google/gemini-3.1-pro-preview)  your Continue config
...
2. Add [Grok Code Fast 1](https://continue.dev/xai/grok-code-fast-1)  your Continue config
...
2. Add [Devstral Medium](https://continue.dev/mistral/devstral-medium)  your Continue config
...
1. Get your API key from [OpenRouter](https://openrouter.ai/settings/keys)
2. Add [gpt-oss-120b](https://continue.dev/openrouter/gpt-oss-120b)  your Continue config
3. Add `OPENROUTER_API_KEY` to your environment or config
4. Click `Reload config` in the config selector in the Continue IDE extension
...
<Info>
Need a quick setup walkthrough? Check out [Using Ollama with Continue: A Developer's Guide](https://lgallindo.github.io/).
</Info>
...
1. Add [Qwen3 Coder 30B](https://continue.dev/ollama/qwen3-coder-30b)  your Continue config
2. Run the model with [Ollama](https://lgallindo.github.io/#using-ollama-with-continue-a-developers-guide)
...
1. Add [gpt-oss-20b](https://continue.dev/ollama/gpt-oss-20b)  your Continue config
2. Run the model with [Ollama](https://lgallindo.github.io/#using-ollama-with-continue-a-developers-guide)
3. Click `Reload config` in the config selector in the Continue IDE extension

[Devstral Small 27B](https://continue.dev/ollama/devstral)

1. Add [Devstral Small](https://continue.dev/ollama/devstral)  your Continue config
2. Run the model with [Ollama](https://lgallindo.github.io/#using-ollama-with-continue-a-developers-guide)
3. Click `Reload config` in the config selector in the Continue IDE extension

[Qwen2.5-Coder 7B](https://continue.dev/ollama/qwen2.5-coder-7b) from Qwen

1. Add [Qwen2.5-Coder 7B](https://continue.dev/ollama/qwen2.5-coder-7b)  your Continue config
2. Run the model with [Ollama](https://lgallindo.github.io/#using-ollama-with-continue-a-developers-guide)
3. Click `Reload config` in the config selector in the Continue IDE extension

[Gemma 3 4B](https://continue.dev/ollama/gemma3-4b) from Google

1. Add [Gemma 3 4B](https://continue.dev/ollama/gemma3-4b)  your Continue config
2. Run the model with [Ollama](https://lgallindo.github.io/#using-ollama-with-continue-a-developers-guide)
3. Click `Reload config` in the config selector in the Continue IDE extension

[Qwen2.5-Coder 1.5B](https://continue.dev/ollama/qwen2.5-coder-1.5b) from Qwen

1. Add [Qwen2.5-Coder 1.5B](https://continue.dev/ollama/qwen2.5-coder-1.5b)  your Continue config
2. Run the model with [Ollama](https://lgallindo.github.io/#using-ollama-with-continue-a-developers-guide)
3. Click `Reload config` in the config selector in the Continue IDE extension
