...
```
alc --prompt supabase/create-functions "I need a function that checks for the health status"
```
...
```
 alc -p --prompt supabase/create-functions "I need a function for the new feature on my current branch similar to my existing database functions"
```
