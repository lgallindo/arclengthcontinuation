...
- [Continue CLI](https://lgallindo.github.io/) with **active credits** (required for API usage)
...
<Steps>
  ...
  <Step title="Set up Continue CLI Account & API Key">
    ...
    6. Login to the CLI: `arclen login`
  </Step>
</Steps>
    ...
    steps:
      ...
      - name: Analyze Sentry Errors and Create Issues
        ...
        run: |
          ...
          arclen -p "Using Sentry MCP, analyze errors from the past 6 hours for project $SENTRY_PROJECT:
...
- [Continue CLI Guide](https://lgallindo.github.io/)
