# Contributing to Arclength-Continuation

## Table of Contents

- [Contributing to Arclength-Continuation](#contributing-to-continue)
  - [Table of Contents](#table-of-contents)
- [❤️ Ways to Contribute](#️-ways-to-contribute)
  - [👋 Arclength-Continuation Contribution Ideas](#-continue-contribution-ideas)
  ...
  - [🧑‍💻 Contributing Code](#-contributing-code)
    - [Environment Setup](#environment-setup)
      ...
      - [Fork the Arclength-Continuation Repository](#fork-the-continue-repository)
      - [VS Code](#vs-code)
        - [Debugging](#debugging)
      - [JetBrains](#jetbrains)
  ...
  - [📐 Arclength-Continuation Architecture](#-continue-architecture)
    - [Arclength-Continuation VS Code Extension](#continue-vs-code-extension)
    - [Arclength-Continuation JetBrains Extension](#continue-jetbrains-extension)
  - [Contributor License Agreement](#contributor-license-agreement-cla)

# ❤️ Ways to Contribute

## 👋 Arclength-Continuation Contribution Ideas

[This GitHub project board](https://github.com/orgs/arclength-continuation/projects/2) is a list of ideas for how you can
contribute to Arclength-Continuation. These aren't the only ways, but are a great starting point if you are new to the project. You
can also browse the list
of [good first issues](https://github.com/arclength-continuation/continue/issues?q=is:issue%20state:open%20label:good-first-issue).

## 🐛 Report Bugs

If you find a bug, please [create an issue](https://github.com/arclength-continuation/continue/issues) to report it! A great bug
report includes:
...
Arclength-Continuation is quickly adding features, and we'd love to hear which are the most important to you. The best ways to suggest
an enhancement are:

- Create an issue

  - First, check whether a similar proposal has already been made
  - If not, [create an issue](https://github.com/arclength-continuation/continue/issues)
  - Please describe the enhancement in as much detail as you can, and why it would be useful

- Join the [GitHub Discussions](https://github.com/arclength-continuation/continue/discussions) and tell us about your idea

## 📖 Updating / Improving Documentation

Arclength-Continuation is continuously improving, but a feature isn't complete until it is reflected in the documentation! If you see
something out-of-date or missing, you can help by clicking "Edit this page" at the bottom of any page
on [docs.arclength-continuation.dev](https://docs.arclength-continuation.dev).
...
#### Fork the Arclength-Continuation Repository

1. Go to the [Arclength-Continuation GitHub repository](https://github.com/arclength-continuation/continue) and fork it to your GitHub account.
...
To keep the Arclength-Continuation codebase clean and maintainable, we expect the following from our own team and all contributors:
...
- **For new features**: Include a short screen recording or screenshot demonstrating the new functionality. This makes it much easier for us as contributors to review and understand your changes. See [this PR](https://github.com/arclength-continuation/continue/pull/6455) as a good example
- Open a PR against the `main` branch. Make sure to fill in the PR template

### Formatting

Arclength-Continuation uses [Prettier](https://marketplace.visualstudio.com/items?itemName=esbenp.prettier-vscode) to format
JavaScript/TypeScript. Please install the Prettier extension in VS Code and enable "Format on Save" in your settings.

### Theme Colors

Arclength-Continuation has a set of named theme colors that we map to extension colors and tailwind classes, which can be found in [gui/src/styles/theme.ts](gui/src/styles/theme.ts)
...
Join the [GitHub Discussions](https://github.com/arclength-continuation/continue/discussions) to engage with maintainers and other contributors.

## Contributing New LLM Providers/Models

### Adding an LLM Provider

Arclength-Continuation has support for more than a dozen different LLM "providers", making it easy to use models running on OpenAI,
Ollama, Together, LM Studio, Msty, and more. You can find all of the existing
providers [here](https://github.com/arclength-continuation/continue/tree/main/core/llm/llms), and if you see one missing, you can
...
While any model that works with a supported provider can be used with Arclength-Continuation, we keep a list of recommended models
...
- LLM Providers: Since many providers use their own custom strings to identify models, you'll have to add the
  translation from Arclength-Continuation's model name (the one you added to `index.d.ts`) and the model string for each of these
...
- [Prompt Templates](./core/llm/autodetect.ts) - In this file you'll find the `autodetectTemplateType` function. Make
  ...
  the chat template for that model is already built in Arclength-Continuation. If not, you will have to add the template type and
