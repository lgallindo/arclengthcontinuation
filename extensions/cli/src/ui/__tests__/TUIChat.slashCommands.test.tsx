...
describe("TUIChat - Slash Commands Tests", () => {
  testBothModes("shows slash when user types /", async (mode) => {
    ...
    if (mode === "remote") {
      ...
      expect(frame).toContain("ArclengthContinuation CLI");
    }
  });
  ...
  testBothModes(
    ...
    async (mode) => {
      ...
      if (mode === "remote") {
        ...
        expect(frameAfterArgs).toContain("ArclengthContinuation CLI");
  ...
  testBothModes(
    ...
    async (mode) => {
      ...
      if (mode === "remote") {
        ...
        expect(frameAfterEnter).toContain("ArclengthContinuation CLI");
      }
    },
  );
});
