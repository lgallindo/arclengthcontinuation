...
describe("UpdateNotification", () => {
    ...
    mockUseServices.mockReturnValue({
      services: {
        update: {
          ...
          message: "ArclengthContinuation CLI v1.0.0",
          error: null,
  ...
  it("should show default message when no update is available", () => {
    ...
    expect(lastFrame()).toContain("◉ ArclengthContinuation CLI v1.0.0");
  });
  ...
  it("should show default message when update service has no message", () => {
    ...
    expect(lastFrame()).toContain("◉ ArclengthContinuation CLI");
  });
});
