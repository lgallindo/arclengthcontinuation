# End-to-End Testing for Arclength-Continuation CLI

This document describes the principles, practices, and patterns for writing end-to-end (E2E) tests for the Arclength-Continuation CLI.
...
expect(result.exitCode).toBe(0);
expect(result.stdout).toContain("Arclength-Continuation CLI");
```
