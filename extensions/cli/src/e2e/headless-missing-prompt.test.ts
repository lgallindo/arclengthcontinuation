...
models:
  - model: gpt-4
    ...
    expect(output).toContain('cfld -p "please review my current git diff"');
    expect(output).toContain('echo "hello" | cfld -p');
    expect(output).toContain('cfld -p "analyze the code in src/"');
  });
