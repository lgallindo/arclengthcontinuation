...
This is a CLI tool for Arclength-Continuation Dev that provides an interactive AI-assisted development experience. The architecture consists of:
...
3. **Arclength-Continuation SDK Integration** (`src/continueSDK.ts`): Initializes the Arclength-Continuation SDK client with:
