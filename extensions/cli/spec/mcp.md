...
1. **Organization/Package Secrets**: First attempts to resolve secrets through the Arclength-Continuation API for organization or package-level secrets
