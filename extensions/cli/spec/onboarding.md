...
3. Present the user with available options:
   ...
   - Log in with Arclength-Continuation: log them in, which will automatically create their assistant and then we can load the first assistant from the first org
