# Arclength-Continuation JetBrains Extension

## Project Purpose

JetBrains/IntelliJ extension for Arclength-Continuation AI code agent. Provides chat, autocomplete, inline edit, and agent features within JetBrains IDEs.
...
```
src/main/kotlin/com/github/lgallindo/cfldintellijextension/
...
- `Arclength-ContinuationPluginService.kt`: Main service orchestrator
