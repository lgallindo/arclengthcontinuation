package com.github.lgallindo.cfldintellijextension.nextEdit
...
//                val nextEditItem = processedItem?.let { convertToNextEditItem(it) }
    ...
    private fun parseProcessedItem(response: Any?): ProcessedItem? {
        return try {
            ...
            val range = com.github.lgallindo.cfldintellijextension.Range(startPosition, endPosition)
            val location = com.github.lgallindo.cfldintellijextension.RangeInFile(filepath, range)
