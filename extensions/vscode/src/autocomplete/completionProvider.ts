...
export class ArclengthContinuationCompletionProvider
  implements vscode.InlineCompletionItemProvider
{
  private async onError(e: unknown) {
    ...
    let message = "ArclengthContinuation Autocomplete Error";
    ...
    vscode.window.showErrorMessage(message, "Documentation").then((val) => {
      if (val === "Documentation") {
        vscode.env.openExternal(
          vscode.Uri.parse(
            "https://docs.arclength-continuation.dev/features/tab-autocomplete",
          ),
        );
      }
    });
    ...
    try {
      ...
      const autocompleteCompletionItem = new vscode.InlineCompletionItem(
        ...
        range,
        {
          ...
          command: "arclength-continuation.logAutocompleteOutcome",
      ...
      if (isFim) {
        ...
        // Ghost text acceptance can *technically* be acted upon in the command handler for "arclength-continuation.logNextEditOutcomeAccept".
        ...
        const nextEditCompletionItem = new vscode.InlineCompletionItem(
          ...
          ),
          {
            ...
            command: "arclength-continuation.logNextEditOutcomeAccept",
