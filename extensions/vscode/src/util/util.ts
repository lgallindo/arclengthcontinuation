...
export function isUnsupportedPlatform(): {
  ...
  //   return {
  //     isUnsupported: true,
  //     reason: `Unsupported platform combination: ${os.platform()}-${os.arch()}. ArclengthContinuation extension supports Windows x64, macOS (Intel/Apple Silicon), and Linux (x64/ARM64).`,
  //   };
  // }
