The `extensions/vscode` folder contains code for the "Arclength-Continuation" VS Code Extension. Arclength-Continuation is a coding extension which extends IDE functionality with AI.
