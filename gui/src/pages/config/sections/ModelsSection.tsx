...
const MODEL_DOCS_URLS = {
  chat: {
    learnMore:
      "https://docs.arclength-continuation.dev/ide-extensions/chat/quick-start",
    setup:
      "https://docs.arclength-continuation.dev/ide-extensions/chat/model-setup",
  },
  autocomplete: {
    learnMore:
      "https://docs.arclength-continuation.dev/ide-extensions/autocomplete/quick-start",
    setup:
      "https://docs.arclength-continuation.dev/ide-extensions/autocomplete/model-setup",
  },
  edit: {
    learnMore:
      "https://docs.arclength-continuation.dev/ide-extensions/edit/quick-start",
    setup:
      "https://docs.arclength-continuation.dev/ide-extensions/edit/model-setup",
  },
} as const;
        ...
        >
          <div className="flex flex-col">
            <ModelRoleRow
              ...
              onConfigure={handleConfigureModel}
              setupURL="https://docs.arclength-continuation.dev/customize/model-roles/apply"
            />
            ...
            <ModelRoleRow
              ...
              onConfigure={handleConfigureModel}
              setupURL="https://docs.arclength-continuation.dev/customize/model-roles/embeddings"
            />
            ...
            <ModelRoleRow
              ...
              onConfigure={handleConfigureModel}
              setupURL="https://docs.arclength-continuation.dev/customize/model-roles/reranking"
            />
          </div>
        </Toggle>
      </Card>
